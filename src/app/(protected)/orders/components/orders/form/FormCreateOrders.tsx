...
export const SelectProducts = () => {
    ...
    // 1. Array do React Hook Form (Armazena a lista FINAL)
    const { fields, append, remove } = useFieldArray({
        control,
        name: 'items'
    })

    const { data, isLoading } = useOrdersCreate()

    // 2. Estados Locais para a "Área de Palco" (Input temporário)
    const [tempProductId, setTempProductId] = useState<string>("")
    const [tempQuantity, setTempQuantity] = useState<string>("1") // String para facilitar input handling
    ...
    // Collection filtrando/desabilitando produtos
    ...
    // Função para adicionar à lista oficial
    const handleAddItem = () => {
        ...
        <Stack width="full" gap={6}>
            ...
            >
                ...
                <HStack align="end" gap={3} flexWrap={{ base: "wrap", md: "nowrap" }}>
                    ...
                    {/* 2. QUANTIDADE (Disabled até selecionar produto) */}
                    ...
                    {/* 3. BOTÃO ADICIONAR (Disabled até tudo estar válido) */}
                    <Button
                        colorPalette="green"
