...
export const TableTopProducts = ({ data }: PropsData) => {
    ...
    return (
        <Flex flex={"1"}>
            ...
            >
                <TextTitle chart="chartLineUp" title="Mais Vendidos" description="Apresenta os 5 produtos com maior volume de vendas no período selecionado, com base nos últimos 30 dias ou no intervalo definido no filtro de datas." />
